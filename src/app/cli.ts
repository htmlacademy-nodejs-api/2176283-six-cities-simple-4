 ...
 * parseCommand - разбирает пользоватеьский ввод. Принимает
 * список переданных пользователем в терминал аргкментов
 * getCommand - проверка команды
 * processCommand - метод исполнения команд. Получает весь
